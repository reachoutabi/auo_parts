...
def get_responsive_header(active_file):
    ...
    <header class="bg-slate-900/95 backdrop-blur-md text-white shadow-xl sticky top-0 z-50 border-b border-slate-800 transition-all w-full">
        <div class="max-w-[1440px] mx-auto px-2 sm:px-4 py-2">
            <div class="flex items-center justify-between gap-2 sm:gap-4">
                ...
                <!-- Nav Links (Compact at 1024px-1280px so 1100px fits perfectly) -->
                ...
                <!-- Header Actions (Compare, Wishlist, Theme, RTL, Auth, Cart) -->
                <div class="flex items-center gap-1 sm:gap-1.5 xl:gap-2 flex-shrink-0">
                    <!-- Compare Button -->
                    <button type="button" onclick="AutoPartsUI.openCompareModal()" class="relative p-1.5 sm:p-2 text-slate-300 hover:text-red-400 transition-colors flex-shrink-0" title="Compare Products">
                    ...
                    <button type="button" onclick="AutoPartsUI.toggleTheme()" class="p-1.5 sm:p-2 text-slate-300 hover:text-amber-400 transition-colors flex-shrink-0" title="Toggle Dark/Light Theme" aria-label="Toggle Dark/Light Theme">
                    ...
                    <!-- RTL Switcher Button -->
                    <button type="button" onclick="AutoPartsUI.toggleRTL()" class="p-1.5 sm:p-2 text-slate-300 hover:text-blue-400 transition-colors flex-shrink-0" title="Toggle LTR/RTL Layout" aria-label="Toggle LTR/RTL Layout">
                    ...
                    <button type="button" onclick="AutoPartsUI.toggleMobileMenu(true)" class="lg:hidden p-1.5 text-slate-200 hover:text-red-400 rounded-xl transition-colors flex-shrink-0" aria-label="Open Navigation Menu">
...
for filepath in html_files:
    ...
    if header_regex.search(content):
        header_html = get_responsive_header(filename)
